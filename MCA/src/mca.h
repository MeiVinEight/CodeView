/*
   ...
   Copyright [2020] [Marco 'DispatchCode' Crivellari]
...
__declspec(dllexport) extern BYTE x86_64_prefix[256];
__declspec(dllexport) extern BYTE modrm_1b[256];
__declspec(dllexport) extern BYTE imm_byte_1b[256];
// check if the OP is Jcc or JMP
__declspec(dllexport) extern BYTE op1b_labels[256];
__declspec(dllexport) extern BYTE modrm_2b[256];
__declspec(dllexport) extern BYTE imm_byte_2b[256];
// check if the OP is Jcc or JMP
__declspec(dllexport) extern BYTE op2b_labels[256];
//
// 3-byte OP look-up table (0x38)
__declspec(dllexport) extern BYTE modreg_3b_38[256];
__declspec(dllexport) extern BYTE imm_byte_3b_38[256];
__declspec(dllexport) extern BYTE modreg_3b_3A[256];
__declspec(dllexport) extern BYTE imm_byte_3b_3A[256];
...
MCAAPI DWORD disasm_operand(char *, QWORD , struct instruction *, WORD);
MCAAPI DWORD disasm(char *, QWORD, struct instruction *);
